...
`README.md` has a **Current Status** table. Update the row when a feature hits ✅ Done. If a feature adds new user-facing capability, update the relevant section above the table too.
